...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drop_window_frame.setGeometry(QRect(0, 0, 600, 250))
        self.drop_window_frame.setMinimumSize(QSize(600, 250))
...
"}")
        ...
        self.name_label = QLabel(self.content_bar)
        self.name_label.setObjectName(u"name_label")
        self.name_label.setMinimumSize(QSize(30, 0))
        self.name_label.setMaximumSize(QSize(60, 20))
        font2 = QFont()
        ...
        self.name_line_edit = QLineEdit(self.content_bar)
        self.name_line_edit.setObjectName(u"name_line_edit")
        self.name_line_edit.setMinimumSize(QSize(400, 25))
        self.name_line_edit.setMaximumSize(QSize(400, 25))

        self.verticalLayout_4.addWidget(self.name_line_edit, 0, Qt.AlignHCenter)

        self.add_key_btn = QPushButton(self.content_bar)
        ...
        self.add_key_btn.setFont(font3)
...
"}")
        ...
        self.verticalLayout_4.addWidget(self.add_key_btn, 0, Qt.AlignHCenter)
